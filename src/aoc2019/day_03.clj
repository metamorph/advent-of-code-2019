...
(defn expand-direction [[dir dist :as direction]]
  (let [delta (case dir
                :U [0 1]
                :D [0 -1]
                :R [1 0]
